...
while(True):
   ...
   # Loop on the outputs
    for detection in networkOutput[0,0]:
        ...
        cv2.putText(img,"Detecting",org1,font,fontScale,color,thickness=2)
        ...
        if status:
            cv2.putText(img,"Normal",org2,font,fontScale,(0, 255, 0),thickness=2)   
        else:
            cv2.putText(img,"Out of Stock",org2,font,fontScale,(0, 0, 255),thickness=2)
